...
const LeftNav = (props) => {
  ...
  return (
    <>
      <div
        className="left-con"
        style={{ display: showsmall ? "block" : "none" }}>
        <div>
          <a className="left-nav-i-box" href="/#">
            {" "}
        ...
        <div>
          <a className="left-nav-i-box" href="/#">
            {" "}
            <FaRegImages className="icon1" />
            <span>Library</span>{" "}
          </a>
        </div>
      </div>
      <div
        className="left-con-sec"
        style={{ display: showbig ? "block" : "none" }}>
